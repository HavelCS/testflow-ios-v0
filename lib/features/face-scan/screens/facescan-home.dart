...
class _FaceScanSetupState extends State<FaceScanSetup> {
  ...
  void _handleVerificationSuccess(Map<String, dynamic> result) {
    ...
    if (result['duplicateDetected'] == false) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const IdentityActiveScreen()),
      );
    } else {
      // Duplicate detected
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: Color.fromARGB(255, 21, 24, 23),
              ),
              child: Padding(
                padding: EdgeInsets.only(top: 36.h, left: 36.0.w),
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Scanning your face creates a\nsecure vault on the Mercle chain,\nyour encrypted key to proving\nyou're you, anywhere.",
                      style: TextStyle(
